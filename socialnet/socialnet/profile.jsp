    ...
    <body class="bg-gray-900 text-gray-200 text-xl xl:px-38 lg:px-24 md:px-12 px-5 tracking-[1px] selection:bg-primary selection:text-gray-900">
        ...
        <div class="w-full h-full flex justify-center items-center p-5">
            ...
            <div class="w-full h-full bg-gray-800 rounded-xl sm:rounded-r-xl flex flex-col justify-center items-center gap-2 p-5">
                ...
                <form class="mb-12 flex flex-col justify-center items-center gap-5 w-full" action="/UserDetServlet" method="post"> 
                    <!-- Inputs -->
                    <div class="flex justify-center items-center gap-5 sm:flex-row flex-col">
                        ...
                        <div class="flex justify-center items-center flex-col gap-2 w-full max-w-[250px]">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" id="street" name="street" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" id="town" name="town" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    placeholder="Town Name" required>
                            </div>

                            <!-- State -->
                            <div class="w-full">
                                <label for="state" class="block text-sm font-medium text-gray-900 dark:text-white">State</label>
                                <input type="text" id="state" name="state" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                        ...
                        <div class="flex justify-center items-center flex-col gap-2 w-full max-w-[250px]">
                            <!-- Field of Study -->
                            <div class="w-full">
                                <label for="fos" class="block text-sm font-medium text-gray-900 dark:text-white">Field of Study</label>
                                <input type="text" id="fos" name="fos" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" id="school" name="school" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
                                    block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    <!-- Bottom of the form (file input/button) -->
                    <div class="flex flex-col items-center justify-center gap-5 max-w-[665px] w-full">
                        <!-- Profile Picture -->
                        <div class="flex items-center justify-center w-full">
                            <label for="pfp" class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 
                                ...
                                <input id="pfp" name="pfp" type="file" class="hidden" />
                            </label>
                        </div> 
