    ...
    <div class="sm:flex hidden">
        ...
        <div class="sm:flex hidden">
            <ul class="flex justify-center items-center gap-10 flex-col sm:flex-row">
                ...
                <li>
                    <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="friends.jsp">
                        Friends
                    </a>
                </li>
                <li>
                    <div class="inline-block relative group z-50">
                        ...
                        <ul class="absolute hidden text-gray-200 pt-1 group-hover:block rounded-md">
                            <li class="">
                                <a href="profile.jsp" class="bg-gray-900 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">
                                    Edit Profile
                                </a>
                            </li>
                            <li class="">
