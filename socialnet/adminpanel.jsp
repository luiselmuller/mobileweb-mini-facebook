...
<html lang="en">
    ...
    <body class="bg-gray-900 text-gray-200 text-xl xl:px-38 lg:px-24 md:px-12 px-5 tracking-[1px] selection:bg-primary selection:text-gray-900">
            ...
            <div class="sm:flex hidden">
                ...
                <div class="sm:flex hidden">
                    <ul class="flex justify-center items-center gap-10 flex-col sm:flex-row">
                        <li>
                            <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="/socialnet/adminpanel.jsp">
                                Search
                            </a>
                        </li>
                        <li>
                            <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="/socialnet/usermanager.jsp">
                                Manage Users
                            </a>
                        </li>
                        <li>
                            <div class="inline-block relative group z-50">
                                ...
                                <ul class="absolute hidden text-gray-200 pt-1 group-hover:block rounded-md">
                                    <li class="">
                                        <a href="/socialnet/adminprofile.jsp" class="bg-gray-900 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">
                                            Edit Profile
                                        </a>
                                    </li>
                                    <li class="">
       ...
       <div class="w-full flex justify-center items-center">
        <form class="w-full" action="/search/users?action=admin-search" method="post">
            <div class="flex">
