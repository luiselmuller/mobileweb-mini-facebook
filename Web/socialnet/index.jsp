...
<html lang="en">
    ...
    <body class="bg-gray-900 text-gray-200 text-xl xl:px-38 lg:px-24 md:px-12 px-5 tracking-[1px] selection:bg-primary selection:text-gray-900">
        ...
        <nav class="h-36 w-full flex items-center justify-end">
            ...
            <div class="sm:flex hidden">
                <ul class="flex justify-center items-center gap-10 flex-col sm:flex-row">
                    <li>
                        <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="login.jsp">
                            Sign In
                        </a>
                    </li>
                    <li>
                        <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="#about">
                            About
                        </a>
                    </li>
                    <li>
                        <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="#contact">
                            Contact
                        </a>
                    </li>
                    <li>
                        <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="#FAQ">
                            FAQ
                        </a>
                    </li>
                </ul>
        ...
        <!-- <div class="h-fit w-full border-b-[2px] border-black p-2 -translate-y-[800px] sm:flex hidden">
            <ul class="flex justify-center items-center gap-10 flex-col sm:flex-row">
                <li>
                    <a class="hover:cursor-pointer hover:text-primary active:text-primary-darker" href="login.jsp">
                        Sign In
        ...
        <section id="hero" class="pt-0 sm:pt-[75px] flex flex-col xl:flex-row h-[900px] px-5 flex">
            ...
            <div class="w-full h-[75%] flex flex-col gap-24 items-start justify-center">
                ...
                <a class="h-16 w-44 shadow-md bg-gradient-to-br from-primary to-primary-darker text-gray-900 font-semibold 
                    ...
                    hover:cursor-pointer flex justify-center items-center" href="login.jsp">
                    Join Us!
                </a>
            </div>
        ...
        <!-- Javascript to handle drawers and mobile menu -->
    </body>
