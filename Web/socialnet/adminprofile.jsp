<%
    ...
    {
        // allow admins to access admin panel
    } else {
    ...
    <body class="bg-gray-900 text-gray-200 text-xl xl:px-38 lg:px-24 md:px-12 px-5 tracking-[1px] selection:bg-primary selection:text-gray-900">
        ...
        <div class="w-full h-full flex justify-center items-center p-5">
            ...
            <div class="w-full h-full bg-gray-800 rounded-xl sm:rounded-r-xl flex flex-col justify-center items-center gap-2 p-5">
                ...
                <form id="admin-info-form" class="mb-12 flex flex-col justify-center items-center gap-5 w-full" action="/admin/info/update" method="post"> 
                    <!-- Inputs -->
                ...
                <form id="admin-pfp-form" action="/admin/profile-picture/update" method="post" enctype="multipart/form-data" class="flex flex-col items-center justify-center gap-5 sm:max-w-[665px] w-full max-w-[250px]">
                    <!-- Profile Picture -->
                    <div class="flex items-center justify-center w-full">
                        <label for="pfp" class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Current image: <%= session.getAttribute("admin-pfp") %></p>
                            </div>
                            <input id="pfp" name="pfp" type="file" class="hidden" accept="image/gif, image/jpeg, image/png" value="<%= session.getAttribute("admin-pfp") %>"/>
                        </label>
                    </div> 

                    <button type="submit" name="admin-image-upload" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full 
